...
public abstract class VehiculoMaletero extends Vehiculo implements Maletero{
    ...
    public VehiculoMaletero(String marca, Estado estado, String modelo, double topSpeed, double cilindraje,
        ...
        super(marca, estado, modelo, topSpeed, cilindraje, numeroPasajeros, tipoCombustible, transmision,            revisionTecnicoMecanica);
